...
export class DecisionLegalActService {
   ...
   */
  async getAllLegalActs(query: GetLegalActDto, user: GetUserDto) {
   ...
   *
   */
  async createLegalAct(legalAct: CreateLegalActDto, user: GetUserDto) {
    const entityManager = await this.loadEntityManager(user.dataBase);
    legalAct.comId = user.companyId;
   ...
   */
  async deleteLegalActById(id: number, user: GetUserDto): Promise<void> {
   ...
   */
  async deleteLegalAct(id: number, user: GetUserDto): Promise<void> {
    const entityManager = await this.loadEntityManager(user.dataBase);
