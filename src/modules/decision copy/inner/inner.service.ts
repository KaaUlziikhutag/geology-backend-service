...
export class InnerService {
   ...
   */
  async getAllInners(query: GetInnerDto, user: GetUserDto) {
   ...
   */
  async getInnerById(innerId: number, user: GetUserDto): Promise<Inner> {
    const entityManager = await this.loadEntityManager(user.dataBase);
   ...
   *
   */
  async createInner(inner: CreateInnerDto, user: GetUserDto) {
    const entityManager = await this.loadEntityManager(user.dataBase);
    inner.comId = user.companyId;
   ...
   */
  async deleteInnerById(id: number, user: GetUserDto): Promise<void> {
   ...
   */
  async deleteInner(id: number, user: GetUserDto): Promise<void> {
    const entityManager = await this.loadEntityManager(user.dataBase);
