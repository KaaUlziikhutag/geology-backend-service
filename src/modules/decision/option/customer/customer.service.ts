...
export class CustomerService {
   ...
   */
  async getAllCustomers(query: GetCustomerDto, user: IUser) {
   ...
   */
  async getCustomerById(customerId: number, user: IUser): Promise<Customer> {
    const entityManager = await this.loadEntityManager(user.dataBase);
   ...
   *
   */
  async createCustomer(customer: CreateCustomerDto, user: IUser) {
    const entityManager = await this.loadEntityManager(user.dataBase);
   ...
   */
  async deleteCustomerById(id: number, user: IUser): Promise<void> {
   ...
   */
  async deleteCustomer(id: number, user: IUser): Promise<void> {
    const entityManager = await this.loadEntityManager(user.dataBase);
